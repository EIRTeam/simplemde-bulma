Supports editor preview with styling in Bulma via the "content" tag. Forked from [https://github.com/Ionaru/simplemde-markdown-editor](https://github.com/Ionaru/simplemde-markdown-editor), which also added the neccessary support for FontAwesome 5.
